      ...
      <div className="container">
        <p className="text">
          ...
          <p>
            ...
            <br />
            <br />
            By downloading UniU from the Apple AppStore, and any update thereto
            (as permitted by this License Agreement), You indicate that You
            ...
            liability, maintenance and support thereof. UniU, not Apple, is
            ...
            Service. UniU acknowledges that it had the opportunity to review
            said terms and this License Agreement is not conflicting with them.
            <br />
            <br />
            All rights not expressly granted to You are reserved.
            <br />
            <br />A copy of this agreement is provided at:{" "}
            <a href="http://www.uniu.it/terms_conditions">
              www.uniu.it/terms_conditions
            </a>
            <br />
            <br />
          </p>
          ...
          <p>
            UniU is a piece of software created to allow users to manage their
            university career efficiently.
            <br />
            <br />
            UniU is not an official app of universities, some data within the
            app may be corrupted or incorrect, rely solely and exclusively on
            the official services offered by your university. Any report for
            corrupt or incorrect data will be appreciated in order to improve
          ...
          <h2>2. WARRANTY</h2>
          <p>
            2.1  Licensor warrants that the Application is free of spyware,
            ...
            <br />
            <br />
            2.2  No warranty is provided for the Application that is not
            ...
            there are any other reasons that may affect the executability of the
            Application.
            <br />
            <br />
            2.3  You are required to inspect the Application immediately after
            installing it and notify UniU about issues discovered without delay
            by e-mail provided in Contact Information. The defect report will be
            taken into consideration and further investigated.
            <br />
            <br />
            2.4  In the event of any failure of the Application to conform to
            ...
            <br />
            <br />
            2.5  If the user is an entrepreneur, any claim based on faults
          ...
          <h2>3. PRODUCT CLAIMS</h2>
          <p>
            UniU and the End-User acknowledge that UniU, and not Apple, is
          ...
          <p>
            ...
            <a href="mailto:uniu.app@gmail.com">uniu.app@gmail.com</a> or visit{" "}
          ...
          <h2>5. TERMINATION</h2>
          <p>
            The license is valid until terminated by UniU or by You. Your rights
            under this license will terminate automatically and without notice
            from UniU if You fail to adhere to any term(s) of this license. Upon
            License termination, You shall stop all use of the Application, and
            destroy all copies, full or partial, of the Application.
            <br />
            <br />
          </p>
          <h2>6. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY</h2>
          <p>
            UniU represents and warrants that UniU will comply with applicable
          ...
          <p>
            UniU and the End-User acknowledge that, in the event of any
            ...
            third party's intellectual property rights, UniU, and not Apple,
          ...
          <h2>8. NO MAINTENANCE OR SUPPORT</h2>
          <p>
            8.1  UniU is not obligated, expressed or implied, to provide any
            maintenance, technical or other support for the Application.
            <br />
            <br />
            8.2  UniU and the End-User acknowledge that Apple has no obligation
          ...
          <p>
            9.1  If any of the terms of this agreement should be or become
            ...
            <br />
            <br />
            9.2  Collateral agreements, changes and amendments are only valid if
